...
var app = {
    ...
    developerKey: 'afc3b634-a443-4919-adda-a60877f3fa32' // RiotGames API Key
}
...
app.stats = {
    ...
    ranked: function(summonerId, vars, cb) {
        app.talk('api/lol/' + app.settings.region + '/v1.3/' + summonerId + '/ranked', vars, cb, app.settings.region)
    },
    /**
    ...
    summary: function(summonerId, vars, cb) {
        app.talk('api/lol/' + app.settings.region + '/v1.3/' + summonerId + '/summary', vars, cb, app.settings.region)
    },
...
app.team = {
     ...
     */
    bySummoner: function(summonerId, vars, cb) {
        app.talk('api/lol/' + app.settings.region + '/v2.4/team/bySummoner' + summonerId, vars, cb, app.settings.region)
    },
    /**
...
app.talk = function(path, fields, cb) {
    ...
    var options = {
        ...
        path: '/' + path + '?' + querystring.stringify(fields) + '&api_key=' + app.developerKey,
        method: 'GET'
    }
